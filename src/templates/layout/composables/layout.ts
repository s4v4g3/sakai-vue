...
const layoutConfig = reactive<{ripple: boolean,
    darkTheme: boolean, inputStyle: string, menuMode: string, theme: string, scale: number, 
...
export function useLayout() {
    ...
    const setActiveMenuItem = (item: Ref<object> | null) => {
